...
[DependsOn(
    ...
    // Theme packages
    typeof(SuperAbpAspNetCoreMvcUiBootstrapFileInputModule),
...
public class ThemeModule : AbpModule
{
    ...
    private void ConfigureLocalization()
    {
        Configure<AbpLocalizationOptions>(options =>
        {
            ...
            options.DefaultResourceType = typeof(ThemeResource);
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<ThemeModule>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<ThemeModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(ThemeModule).Assembly);
        });
    }
